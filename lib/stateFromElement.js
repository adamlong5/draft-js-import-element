...
var _global$Draft = global.Draft;
var CharacterMetadata = _global$Draft.CharacterMetadata;
var ContentBlock = _global$Draft.ContentBlock;
var ContentState = _global$Draft.ContentState;
var Entity = _global$Draft.Entity;
var genKey = _global$Draft.genKey;
...
var ELEM_TO_ENTITY = {
  a: function a(tagName, element) {
    ...
    if (data.url != null) {
      return Entity.create(_draftJsUtils.ENTITY_TYPE.LINK, 'MUTABLE', { href: data.url });
    }
  },
  img: function img(tagName, element) {
    ...
    if (data.src != null) {
      return Entity.create(_draftJsUtils.ENTITY_TYPE.IMAGE, 'MUTABLE', data);
    }
  }
};
